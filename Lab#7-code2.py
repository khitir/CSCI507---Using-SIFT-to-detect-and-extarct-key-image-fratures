...
selected_keypoints = keypoints[-6:]

# Draw the first 10 keypoints on the image
image_with_keypoints = cv2.drawKeypoints(image, selected_keypoints, None, color=(0, 255, 0))

# Display the image with keypoints
plt.figure(figsize=(10, 10))
plt.imshow(image_with_keypoints, cmap='gray')
plt.title('First 10 Keypoints Detected')
plt.show()